...
//{
//	Stiva* cap;
//	cap = citireStackMasiniDinFisier("masini_sortate.txt");
//	//afisareMasina(popStack(&cap));
//
//	printf("================================================\n\n");
//
//	Coada capCoada = citireCoadaDeMasiniDinFisier("masini_sortate.txt");
//	afisareMasina(dequeue(&capCoada));
//
//	printf("================================================\n\n");
//	float pret = calculeazaPretTotal(&cap);
//	printf("Pretul total este: %.2f", pret);
//
//	return 0;
//}